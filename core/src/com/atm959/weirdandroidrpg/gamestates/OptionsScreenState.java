...
public class OptionsScreenState extends GameState {
	...
	private final boolean startGameOnExit;
	...
	public OptionsScreenState(boolean startGameOnExit) {
		...
		showFPSAndDelta = Options.showDebugInfo;
	...
	public void run() {
		...
		TextRenderer.renderString(LEFT_HANDED_STRING, rightHandedCheckbox.xPos + rightHandedCheckbox.size + (int) (0.5f * Level.tileSize), rightHandedCheckbox.yPos + (int) (0.25 * Level.tileSize), TextRenderer.TEXT_SCALE_SMALL);
		TextRenderer.renderString(DPAD_STRING, rightHandedCheckbox.xPos + rightHandedCheckbox.size + (int) (0.5f * Level.tileSize) + (3 * TextRenderer.TEXT_SCALE_SMALL), rightHandedCheckbox.yPos + (int) (0.75 * Level.tileSize), TextRenderer.TEXT_SCALE_SMALL);
		TextRenderer.renderString(DPAD_OPACITY_STRING, dpadOpacitySlider.xPos + (int) (0.5f * TextRenderer.TEXT_SCALE_MEDIUM), dpadOpacitySlider.yPos - TextRenderer.TEXT_SCALE_MEDIUM, TextRenderer.TEXT_SCALE_MEDIUM);
		TextRenderer.renderString(SHOW_FPS_STRING, (int) (showFPSAndDeltaCheckbox.xPos + showFPSAndDeltaCheckbox.size + (int) (0.5f * Level.tileSize) + (1.5f * TextRenderer.TEXT_SCALE_SMALL)), showFPSAndDeltaCheckbox.yPos + (int) (0.25 * Level.tileSize), TextRenderer.TEXT_SCALE_SMALL);
		TextRenderer.renderString(AND_DELTA_STRING, (int) (showFPSAndDeltaCheckbox.xPos + showFPSAndDeltaCheckbox.size + (int) (0.5f * Level.tileSize) + TextRenderer.TEXT_SCALE_SMALL), showFPSAndDeltaCheckbox.yPos + (int) (0.75 * Level.tileSize), TextRenderer.TEXT_SCALE_SMALL);
		...
		if (saveButton.isPressed) {
			...
			Options.showDebugInfo = showFPSAndDelta;
		...
		TextRenderer.renderString(dpadOpacityPercentageString, dpadOpacitySlider.xPos + (dpadOpacitySlider.width / 2) - ((dpadOpacityPercentageString.length() * TextRenderer.TEXT_SCALE_LARGE) / 2), (int) (dpadOpacitySlider.yPos + 0.35f * Level.tileSize), TextRenderer.TEXT_SCALE_LARGE);
		String saveString = "SAVE";
		if (startGameOnExit) saveString += " & PLAY";
		int saveScale = TextRenderer.TEXT_SCALE_LARGE;
		if (startGameOnExit) saveScale = TextRenderer.TEXT_SCALE_MEDIUM;
