...
public class ViewMapState extends GameState {
	...
	private final Item[] loadedItems;
	private final NPC[] loadedNPCs;
	private Texture texture;
	private final SpriteBatch sb;
	private final Pixmap mapPixels;
	private float playerPixelTimer;
	private boolean playerPixelIsGreen = false;
	private final Texture mapBG;
	...
	public void run() {
		...
		TextRenderer.renderString("VIEW MAP ", 0, 0, TextRenderer.TEXT_SCALE_LARGE);
		TextRenderer.renderString("TAP TO EXIT", 0, TextRenderer.TEXT_SCALE_LARGE, TextRenderer.TEXT_SCALE_LARGE);
