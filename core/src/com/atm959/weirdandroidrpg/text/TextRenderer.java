 ...
 * A text renderer that can be used to render text
 */
public class TextRenderer {
	...
	public static final int TEXT_SCALE_SMALL = Gdx.graphics.getWidth() / 20;
	public static final int TEXT_SCALE_MEDIUM = Gdx.graphics.getWidth() / 16;
	public static final int TEXT_SCALE_LARGE = Gdx.graphics.getWidth() / 12;
	public static float lastScale; //The scale of the previously-rendered text
	public static float lastY; //The Y position of the previously-rendered text
